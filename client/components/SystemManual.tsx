...
const TeacherManual: React.FC = () => (
  <div>
    ...
    <Section title="三、問答管理（課業問答題庫）">
      <Step n={1} text="點選「問答管理」，可新增、編輯、刪除問答（問題＋答案＋分類）。" />
      <Step n={2} text="這些問答會出現在學生的「課業問答」頁，供學生用關鍵字搜尋瀏覽。" />
      <Step n={3} text="同一批問答也會成為「測驗系統」的出題來源。" />
      <Note>「課業問答」是讓學生搜尋老師預先建立好的問答，並非即時 AI 生成；要自由問 AI 請用 AR 頁的「AI 助教」。</Note>
    </Section>
...
const StudentManual: React.FC = () => (
  <div>
    ...
    <Section title="二、課業問答（搜尋題庫）">
      <Step n={1} text="點選「課業問答」，選擇課程後在搜尋框輸入關鍵字（例如：OK鏡、散光）。" />
      <Step n={2} text="點選問題即可展開詳解，最上方💡會顯示重點摘要。" />
      <Step n={3} text="答案預設顯示前 3 行，點「展開全文」可看完整內容。" />
      <Note>「課業問答」是搜尋老師建立好的問答題庫；若想自由發問、由 AI 即時回答，請用 AR 頁右側的「AI 助教」。</Note>
    </Section>
